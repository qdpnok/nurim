export const productAirSpecs = {
  ...
  41: [
    {
      ...
      items: [
        ...
        { label: "청정면적", value: "6평(19.8㎡)", fullWidth: true },
    ...
    },
    {
      category: "테이블 & 편의기능",
      items: [
        { label: "무선충전", value: "O", fullWidth: true },
        { label: "무드조명", value: "O" },
    ...
    },
    {
      category: "규격 및 인증",
      items: [
        { label: "크기(WxHxD)", value: "275x550x275mm", fullWidth: true },
        { label: "무게", value: "7.1kg" },
        { label: "CA인증", value: "O" },
        {
          label: "적합성평가인증",
          value: "R-R-LGE-AS062PRHAR",
          fullWidth: true,
        },
      ],
    },
  ...
  42: [
    {
      ...
      items: [
        ...
        { label: "청정면적", value: "34평(114㎡)", fullWidth: true },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "클린부스터", value: "O", fullWidth: true },
        { label: "UV살균", value: "O" },
    ...
    },
    {
      category: "특화 모드 & 센서",
      items: [
        { label: "펫모드", value: "O", fullWidth: true },
        { label: "베이비케어", value: "O" },
        { label: "오토모드", value: "O" },
    ...
    },
    {
      category: "규격 및 인증",
      items: [
        { label: "크기(WxHxD)", value: "377x1100x377mm", fullWidth: true },
        { label: "무게", value: "19.9kg", fullWidth: true },
        { label: "CA인증", value: "O" },
        { label: "BAF인증", value: "O" },
        {
          label: "적합성평가인증",
          value: "R-R-LGE-AS353NGDA",
          fullWidth: true,
        },
      ],
    },
  ...
  43: [
    {
      ...
      items: [
        ...
        { label: "청정면적", value: "30.2평(100㎡)", fullWidth: true },
        { label: "소비전력", value: "70W" },
        { label: "소음", value: "18dB", fullWidth: true },
      ],
    },
    {
      category: "프리미엄 청정 & 필터",
      items: [
        { label: "필터특징", value: "워셔블 살균 집진 필터", fullWidth: true },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "AI+인증", value: "O", fullWidth: true },
      ],
    },
    {
      category: "스마트 / 편의",
  ...
  44: [
    {
      ...
      items: [
        ...
        { label: "청정면적", value: "32평(106㎡)", fullWidth: true },
        { label: "소비전력", value: "80W" },
        { label: "소음", value: "20dB", fullWidth: true },
      ],
    },
    {
      category: "청정 및 위생",
      items: [
        { label: "3WAY스마트토출", value: "O", fullWidth: true },
  ...
  45: [
    ...
    },
    {
      category: "모드 및 센서",
      items: [
        { label: "디퓨즈모드", value: "O", fullWidth: true },
        { label: "자동모드", value: "O" },
        { label: "수면모드", value: "O" },
        { label: "가스(냄새)센서", value: "O" },
      ],
    ...
    },
    {
      category: "규격",
      items: [
        { label: "크기(WxHxD)", value: "220x1050x220mm", fullWidth: true },
        { label: "인증", value: "상세설명 참조", fullWidth: true },
      ],
    },
  ],

  // 6. Dyson 빅+콰이엇 포름알데히드
  46: [
    {
      category: "기본 정보",
      items: [
        ...
        { label: "청정면적", value: "30.25평(100㎡)", fullWidth: true },
    ...
    },
    {
      ...
      items: [
        { label: "360도 필터", value: "O" },
        { label: "포름알데히드분해", value: "O", fullWidth: true },
        { label: "이산화질소(NO2)제거", value: "O", fullWidth: true },
        { label: "초미세먼지제거", value: "O" },
        { label: "새집증후군제거", value: "O" },
    ...
    },
    {
      category: "첨단 센서 & 조절",
      items: [
        { label: "센서", value: "포름알데히드센서", fullWidth: true },
        { label: "공기흐름조절", value: "0°, 25°, 50° 조절", fullWidth: true },
    ...
    },
    {
      category: "규격",
      items: [
        { label: "크기(WxHxD)", value: "434x830x434mm", fullWidth: true },
  ...
  47: [
    {
      ...
      items: [
        ...
        { label: "청정면적", value: "18평(60㎡)", fullWidth: true },
        { label: "에너지효율", value: "3등급" },
    ...
    },
    {
      category: "청정 및 모드",
      items: [
        { label: "제트클린모드", value: "O", fullWidth: true },
        { label: "초미세먼지제거", value: "O" },
        { label: "새집증후군제거", value: "O" },
        { label: "유해가스제거", value: "O" },
        { label: "탈취", value: "O" },
        { label: "자동/터보모드", value: "O" },
      ],
    },
    {
      category: "디자인 & 편의",
      items: [
        { label: "무드업(LED)", value: "빛의 기둥", fullWidth: true },
        { label: "이동손잡이", value: "O" },
        { label: "풍량조절", value: "O" },
        { label: "소음", value: "19~64dB", fullWidth: true },
      ],
    },
    {
      category: "규격",
      items: [
        { label: "크기(WxHxD)", value: "260x700x260mm", fullWidth: true },
  ...
  48: [
    {
      ...
      items: [
        ...
        { label: "청정면적", value: "25.9평(85.8㎡)", fullWidth: true },
        { label: "에너지효율", value: "1등급", fullWidth: true },
    ...
    },
    {
      category: "강력 청정 & 모드",
      items: [
        { label: "슈퍼청정모드", value: "O", fullWidth: true },
        { label: "360도 필터", value: "O" },
        { label: "초미세먼지제거", value: "O" },
        { label: "유해가스/탈취", value: "O" },
        { label: "새집증후군제거", value: "O" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "조도센서", value: "O" },
        { label: "CA인증", value: "O" },
        { label: "KAA아토피인증", value: "O", fullWidth: true },
      ],
    },
    {
      category: "스마트 / 편의",
      items: [
        ...
        { label: "이동식바퀴", value: "O", fullWidth: true },
        { label: "미세먼지농도표시", value: "O" },
        { label: "청정도표시", value: "O" },
        { label: "필터교체알림", value: "O" },
      ],
  ...
  49: [
    {
      ...
      items: [
        ...
        { label: "청정면적", value: "13평(43㎡)", fullWidth: true },
        { label: "에너지효율", value: "2등급" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "유해가스제거", value: "O" },
        { label: "새집증후군제거", value: "O" },
        { label: "센서", value: "PM10(미세먼지)", fullWidth: true },
        { label: "조도센서", value: "O" },
      ],
    },
    {
    ...
    },
    {
      category: "규격 및 인증",
      items: [
        { label: "크기(WxHxD)", value: "384x594x220mm", fullWidth: true },
        { label: "무게", value: "7.9kg" },
        { label: "소음", value: "49.1dB", fullWidth: true },
        { label: "CA인증", value: "O" },
        { label: "인증", value: "상세설명 참조", fullWidth: true },
      ],
    },
...
// [추가] 구매 페이지용 데이터 매핑 (91~100번)
// 구매용 상품 클릭 시에도 동일한 스펙 데이터를 보여주기 위해 키를 복사합니다.
productAirSpecs[91] = productAirSpecs[41];
productAirSpecs[92] = productAirSpecs[42];
productAirSpecs[93] = productAirSpecs[43];
productAirSpecs[94] = productAirSpecs[44];
productAirSpecs[95] = productAirSpecs[45];
productAirSpecs[96] = productAirSpecs[46];
productAirSpecs[97] = productAirSpecs[47];
productAirSpecs[98] = productAirSpecs[48];
productAirSpecs[99] = productAirSpecs[49];
productAirSpecs[100] = productAirSpecs[50];
